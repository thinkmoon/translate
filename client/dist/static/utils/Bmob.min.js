  ...
  return function (e) {
    ...
    var r = n(0);var o = n(4),
      ...
      _createClass(_class2, [{
        ...
        value: function set(e, t) {
          if (!i(e) || c(t)) throw new l(415);var n = t.filename,
              r = t.cdn,
              o = t.url;
        ...
        value: function or() {
          ...
          });var t = this.queryData.$and;if (!c(t)) for (var _n2 = 0; _n2 < t.length; _n2++) {
        ...
        value: function relation(e) {
          ...
          if (!i(e)) throw new l(415);return "_User" === e && (e = "users"), new Promise(function (t, n) {
            o("/1/" + e, "get", _this5.queryReilation).then(function (_ref3) {
              var e = _ref3.results;
              t(e);
            }).catch(function (e) {
              n(e);
        ...
        value: function find() {
          ...
          var e = {},
              t = {},
              n = {};Object.keys(this.queryData).length && (t.where = this.queryData), Object.keys(this.location).length && (t.where = Object.assign(this.location, this.queryData)), Object.keys(this.andData).length && (t.where = Object.assign(this.andData, this.queryData)), Object.keys(this.orData).length && (t.where = Object.assign(this.orData, this.queryData)), t.limit = this.limitNum, t.skip = this.skipNum, t.include = this.includes, t.order = this.orders, t.keys = this.keys;for (var _e3 in t) {
            (t.hasOwnProperty(_e3) && null === t[_e3] || 0 === t[_e3]) && delete t[_e3];
          }var s = function s(t, n) {
            if (!t || c(n)) throw new l(415);e[t] = n;
          },
              i = function i() {
            var t = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "updata";
            if (console.log(t), n.length < 1) throw new l(416);var s = void 0,
                i = void 0,
                a = "put",
                c = [];n.map(function (n) {
              return "/undefined" === (s = "/" + n.objectId) && (s = "", a = "post"), i = { method: a, path: "" + _this6.tableName + s, body: e }, "delete" === t && (i = { method: "DELETE", path: "" + _this6.tableName + s }), c.push(i), n;
            });var u = { requests: c },
                p = r._config.parameters.BATCH;return o(p, "POST", u);
          };return new Promise(function (e, r) {
            o("" + _this6.tableName, "get", t).then(function (_ref4) {
              var t = _ref4.results;
              _this6.init(), Object.defineProperty(t, "set", { value: s }), Object.defineProperty(t, "saveAll", { value: function value() {
                  return i();
        ...
        value: function count() {
          ...
          var e = {};return Object.keys(this.queryData).length && (e.where = this.queryData), Object.keys(this.andData).length && (e.where = Object.assign(this.andData, this.queryData)), Object.keys(this.orData).length && (e.where = Object.assign(this.orData, this.queryData)), e.count = 1, new Promise(function (t, n) {
            o("" + _this7.tableName, "get", e).then(function (_ref5) {
              var e = _ref5.count;
              t(e);
            }).catch(function (e) {
              n(e);
      ...
      return new Promise(function (i, a) {
        void 0 === o.User && (o = n(0));var c = function (e) {
          var t = { "content-type": "application/json", "X-Bmob-SDK-Type": "wechatApp", "X-Bmob-Application-Id": e.applicationId, "X-Bmob-REST-API-Key": e.applicationKey };return e.applicationMasterKey && (t["X-Bmob-Master-Key"] = e.applicationMasterKey), t;
            ...
            p = { url: e, method: t };"get" === p.method ? p.params = s : p.data = s, l(p).then(function (_ref6) {
          var e = _ref6.data;
          e.code && a(e), i(e);
        }).catch(function (e) {
          a(e);
    ...
    (function (t) {
      var r = n(0),
          ...
          _ = _n3.push,
          _n4 = n(53),
          x = _n4.requestSmsCode,
          j = _n4.verifySmsCode;r.GeoPoint = v, r.generateCode = p, r.sendMessage = f, r.getAccessToken = h, r.sendWeAppMessage = d, r.refund = m, r.checkMsg = T, r.notifyMsg = w, r.requestSmsCode = x, r.verifySmsCode = j, r.functions = g, r.timestamp = y, r.requestPasswordReset = b, r.resetPasswordBySmsCode = S, r.updateUserPassword = E, r.push = _, r.Pay = new u(), r.User = new a(), r.Socket = l, r.Query = function (e) {
        return new i(e);
      }, r.File = function (e, t) {
        return new c(e, t);
    ...
    function i(e, t) {
      ...
      if (r(e)) return { __op: t, objects: [{ __type: "Pointer", className: this.tableName, objectId: e }] };if (o(e)) {
        var _n7 = [];return e.map(function (e) {
          if (!r(e)) throw new s(415);_n7.push({ __type: "Pointer", className: _this8.tableName, objectId: e });
        }), { __op: t, objects: _n7 };
      }throw new s(415);
    }e.exports = function () {
      function _class4(e) {
    ...
    var r = n(0);e.exports = function (e) {
      ...
      return new Promise(function (s, i) {
        var a = function (e) {
          var t = { "content-type": "application/json", "X-Bmob-SDK-Type": "wechatApp", "X-Bmob-Application-Id": e.applicationId, "X-Bmob-REST-API-Key": e.applicationKey };return e.applicationMasterKey && (t["X-Bmob-Master-Key"] = e.applicationMasterKey), t;
        }(r._config);void 0 === r.User && (r = n(0));var c = r.User.current();c && (a["X-Bmob-Session-Token"] = c.sessionToken), "xxrequire('@system.fetch')xx".fetch({ url: r._config.host + e, header: a, method: t, data: o, success: function success(e) {
    ...
    var o = void 0;o = "undefined" != typeof cc ? cc.sys.localStorage : localStorage, console.log(o);var s = {
      ...
      _createClass(_class5, [{
        ...
        value: function login(e, t) {
          ...
          if (!u(e) || !u(t)) throw new a(415);this.setData = Object.assign({}, { username: e, password: t });var n = i._config.parameters.LOGIN;return new Promise(function (e, t) {
            r(n, "get", _this10.setData).then(function (t) {
              o.save("bmob", t), e(t);
            }).catch(function (e) {
        ...
        value: function loginWithWeapp(e) {
          ...
          return new Promise(function (t, n) {
            _this11.requestOpenId(e).then(function (e) {
              var n = { weapp: e },
                  r = _this11.linkWith(n);t(r);
            }).catch(function (e) {
              n(e);
            });
          });
        ...
        value: function upInfo(e) {
          ...
          return new Promise(function (t, n) {
            var r = e.nickName,
                s = e.avatarUrl,
                i = _this12.current();if (!i) throw new a(415);var c = o.fetch("openid");_this12.get(i.objectId).then(function (e) {
      ...
      _createClass(_class6, [{
        ...
        value: function destroy(e) {
          if (c(e)) return r(o._config.parameters.FILES + "/upyun/" + e.split(".com/")[1], "delete");if (u(e)) {
            var _t2 = [];return e.map(function (e) {
              _t2.push(e.split(".com/")[1]);
            }), r(o._config.parameters.DELFILES, "post", { upyun: _t2 });
          }throw new s(415);
        }
      }]);
      ...
      _createClass(_class8, [{
        ...
        value: function initialize() {
          ...
          return this.handshake().then(function (e) {
            try {
              _this13.connect("wss://" + _this13.config.host + "/socket.io/1/websocket/" + e, {});
            } catch (e) {
            ...
            _this13.on("server_pub", function (e) {
              switch (e.action) {case "updateTable":
                  _this13.onUpdateTable(e.tableName, e.data);break;case "updateRow":
                  _this13.onUpdateRow(e.tableName, e.objectId, e.data);break;case "deleteTable":
                  _this13.onDeleteTable(e.tableName, e.data);break;case "deleteRow":
                  _this13.onDeleteRow(e.tableName, e.objectId, e.data);}
            }), _this13.on("client_send_data", function (e) {
              _this13.onInitListen();
            });
          });
        }
      }, {
              ...
              try {
                var _t3 = function _t3(e) {
                  ...
                  return { name: t, args: n };
                    ...
                    _n15 = e.data;if ("2:::" === _n15.slice(0, 4) && _this14.emit(!1, !0), null === (_n15 = _n15.slice(4)) || "" === _n15) return;
                var _t4 = _t3(_n15),
                    _r2 = _t4.name,
                    _o2 = _t4.args;

                var _s2 = null == _o2 ? "" : JSON.parse(_o2[0]);_this14.emitter.emit(_r2, _s2);
              } catch (t) {
                console.log("Handle packet failed: " + e.data, t);
              }
            }), wx.onSocketClose(function () {
              return _this14.emitter.emit("close");
    ...
    var r = n(4),
      ...
      }, geoPoint: function geoPoint(_ref9) {
        var e = _ref9.latitude,
            t = _ref9.longitude;
        return function (e, t) {
